...
- Improve copy following copywriting best practices
...
Use good copywriting guidelines:
...
- Leverage Astro's zero-JS-by-default for performance
- Add client-side interactivity only when needed (`client:load`, `client:visible`)
...
| **onboarding** | Initial project setup if SITE.md doesn't exist |
...
| Page components | `src/components/` | Reusable Astro components |
| Pages | `src/pages/` | The rebuilt pages |
